...
def get_data_folder(dataset):
    ...
    if hostname.startswith('c4'):
        if dataset == "imagenet":
            data_folder = "/home/users/kzhao27/imagenet_data"
        elif dataset == "tiny-imagenet":
            data_folder = "/home/users/kzhao27/tiny-imagenet-200"
        else:
...
def get_imagenet_dataloader_sample(dataset='imagenet', batch_size=128, num_workers=8, is_sample=False, k=4096):
    ...
    crop_size = 64 if dataset == "tiny-imagenet" else 224
    img_size = 64 if dataset == "tiny-imagenet" else 256
...
def get_imagenet_dataloader(dataset='imagenet', batch_size=128, num_workers=16, is_instance=False):
    ...
    print(f'Num of classes: {len(train_set.classes)}')
    print(f'Num of training data: {len(train_set)}')

    if is_instance:
        return train_loader, test_loader, n_data, len(train_set.classes)
    else:
